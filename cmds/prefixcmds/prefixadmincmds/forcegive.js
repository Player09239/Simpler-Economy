...
module.exports = async (message, client) => {
    try {
        ...
        if (command === `${b.prefix}o-forcegive`) {
            ...
            if (!user) {
                ...
                const err = new EmbedBuilder()  
                    .setTitle('Error')
                    .setColor('Red')
                    .setDescription(`Arguments missing, expected: **${b.prefix}o-forcegive <userId> <amount>**`)
                    .setTimestamp()
                ...
                const given = new EmbedBuilder()
                    .setTitle('Admin ForceGive')
                    .setColor('#36393F')
                    .setDescription(`
**${user.username}**

**>** **Given Cookies** ${await format(amount)} 🍪
                    `)
                    .setTimestamp()

                return message.channel.send({ embeds: [given] })
            }
        }
    } catch (error) {
